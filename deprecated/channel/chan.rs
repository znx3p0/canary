...
/// ```
#[derive(From)]
pub enum UnformattedChannel {
    Unified(crate::channel::unified::UnifiedChannel), // has not been divided
    Bipartite(crate::channel::bipartite::BidirectionalChannel), // has been divided
}

#[derive(From)]
pub enum RefUnformattedChannel {
    Unified(crate::channel::unified::UnifiedChannel), // has not been divided
    Bipartite(crate::channel::bipartite::BidirectionalChannel), // has been divided
}
